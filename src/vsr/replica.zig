...
pub fn ReplicaType(
    ...
    return struct {
        ...
        /// Returns the oldest op that the replica must repair.
        ...
        ///     the cluster, so that they can help backups catch up.
        fn op_repair_min(self: *const Self) u64 {
            ...
            const op = op: {
                if (self.primary_index(self.view) == self.replica) {
                    ...
                    if (self.op_checkpoint() == self.op or self.op_checkpoint() == 0) {
